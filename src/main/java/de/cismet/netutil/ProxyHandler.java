...
public class ProxyHandler {
    ...
    private ProxyHandler() {
        ...
        this.propertiesHandler = (propertiesHandler != null) ? propertiesHandler : new ServerProxyPropertiesHandler();
        if (this.propertiesHandler != null) {
            initProperties(this.propertiesHandler);
        }
    }
    ...
    private void initProperties(final ProxyPropertiesHandler propertiesHandler) {
        ...
        if (properties != null) {
            ...
            System.out.println("Proxy found" + String.valueOf(enabled) + " " + String.valueOf(host) + " "
                        + String.valueOf(port) + " " + String.valueOf(domain) + " " + String.valueOf(excludedHosts));
     ...
     * @version  $Revision$, $Date$
     */
    private static class ServerProxyPropertiesHandler implements ProxyPropertiesHandler {
