...
public class PasswordEncrypter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Password Encrypt");
        jLabel1.setFont(new java.awt.Font("MS Sans Serif", 1, 12));
        jLabel1.setText("Password Encrypter cismet GmbH");
        ...
        jLabel3.setText("Bitte wiederholen");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
    ...
    private void cmdGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdGoActionPerformed
        ...
        if (p1.equals(p2)) {
            ...
            JOptionPane.showMessageDialog(this,"Die Passw�rter sind nicht identisch. Bitte nochmals eingeben.","Fehler",JOptionPane.ERROR_MESSAGE);
