...
public class StaticXMLTools {
    ...
    public static Element convertColorToXML(Color c) {
        ...
        colorElement.setAttribute("red", new Integer(c.getRed()).toString());
        colorElement.setAttribute("green", new Integer(c.getGreen()).toString());
        colorElement.setAttribute("blue", new Integer(c.getBlue()).toString());
        colorElement.setAttribute("alpha", new Integer(c.getAlpha()).toString());
        return colorElement;
    }
    ...
    public static Color convertXMLElementToColor(Element xmlElement) {
        ...
        try {
            red = new Integer(xmlElement.getAttributeValue("red")).intValue();
        } catch (Exception skip) {}
        try {
            green = new Integer(xmlElement.getAttributeValue("green")).intValue();
        } catch (Exception skip) {}
        try {
            blue = new Integer(xmlElement.getAttributeValue("blue")).intValue();
        } catch (Exception skip) {}
        try {
            alpha = new Integer(xmlElement.getAttributeValue("alpha")).intValue();
        } catch (Exception skip) {}
    ...
    public static Element convertFontToXML(Font f) {
        ...
        fontElement.setAttribute("name", f.getFamily());
        fontElement.setAttribute("style", new Integer(f.getStyle()).toString());
        fontElement.setAttribute("size", new Integer(f.getSize()).toString());
        return fontElement;
    }
    ...
    public static Font convertXMLElementToFont(Element xmlElement) {
        ...
        try {
            style = new Integer(xmlElement.getAttributeValue("style")).intValue();
        } catch (Exception skip) {}
        try {
            size = new Integer(xmlElement.getAttributeValue("size")).intValue();
        } catch (Exception skip) {}
