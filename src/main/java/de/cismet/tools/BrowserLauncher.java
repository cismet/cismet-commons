            ...
            case MRJ_2_0:
                {
                    try {
                        ...
                        putParameter =
                            appleEventClass.getDeclaredMethod("putParameter", new Class[] { int.class, aeDescClass }); // NOI18N
                        ...
                        final Field autoGenerateReturnIDField = appleEventClass.getDeclaredField(
            ...
            case MRJ_2_1:
                {
                    try {
                        ...
                        getFileCreator =
                            mrjFileUtilsClass.getDeclaredMethod("getFileCreator", new Class[] { File.class }); // NOI18N
    ...
    private static Object locateBrowser() {
        ...
        switch (jvm) {
            case MRJ_2_0:
                {
                    try {
                        final Integer finderCreatorCode = (Integer) makeOSType.invoke(
                            null,
            ...
            case MRJ_2_1:
                {
                    ...
                    try {
                        ...
                        browser = null;
                        errorMessage =
                            ite.getTargetException().getClass() + ": " + ite.getTargetException().getMessage(); // NOI18N
                        return browser;
                    }
