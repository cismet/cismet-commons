...
public class PostGisGeometryFactory implements IGeometryFactory {
     ...
     */
    private static LineString createJtsLineString(
        final org.postgis.LineString lineString,
     ...
     */
    private static LinearRing createJtsLinearRing(
        final org.postgis.LinearRing linearRing,
        final GeometryFactory geometryFactory
    ) {
     ...
     */
    private static MultiPoint createJtsMultiPoint(
        final org.postgis.MultiPoint multiPoint,
        final GeometryFactory geometryFactory
    ) {
     ...
     */
    private static MultiLineString createJtsMultiLineString(
        final org.postgis.MultiLineString multiLineString,
        final GeometryFactory geometryFactory
    ) {
     ...
     */
    private static MultiPolygon createJtsMultiPolygon(
        final org.postgis.MultiPolygon multiPolygon,
        final GeometryFactory geometryFactory
    ) {
