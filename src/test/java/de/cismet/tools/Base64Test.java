...
public class Base64Test {
    ...
    public void testToBase64UTF8() throws Exception {
        ...
        expResult =
            "IcKnJFcpcmd1w59wNDNyaGdvw7YzICAgIDRsYWhyc2JqZ8O2b3EzNWV1bHJnaGZnbnEzbiA0d2N0\r\nw6R3LXNlZWpyZ2RuMzVsZSxyIGjDtjMgOC1pdGVucTVnNC5ldCBmZ2IsIG0=".getBytes(
                    "UTF-8"
                );
        result = Base64.toBase64(input.getBytes("UTF-8"), true);
        assertArrayEquals(expResult, result);
        ...
        input =
            "1ü0ß234z58hlkl dtu3ä95er-gjä3 rötuo-§Q%OJEZHj4pw5erHJTQ §tuä3 5-j FG AUecpthzu43p uwg#QBE >SJ>D Gjqhä6" +
