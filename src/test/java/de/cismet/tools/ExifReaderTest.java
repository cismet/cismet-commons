...
public class ExifReaderTest {
    ...
    @Test
    public void test010ExifReader()
        throws IOException, URISyntaxException, ImageProcessingException, MetadataException {
        ...
        final ExifReader exifReader = new ExifReader(file);
    ...
    @Test
    public void test020ExifReaderWithDirection()
        throws IOException, URISyntaxException, ImageProcessingException, MetadataException {
